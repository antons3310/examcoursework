...
class JavaQuestionRepositoryTest {
    ...
    void AddByObjectTest() {
        out.add(JAVA_ETALON_QUESTION);
        assertTrue(out.getAll().contains(JAVA_ETALON_QUESTION));
    }
    ...
    void removeTestQuestionNotFound() {
        out.add(QUESTION_TO_REMOVE);
        assertThrows(QuestionNotFoundException.class, () -> out.remove(JAVA_ETALON_QUESTION));
    }
